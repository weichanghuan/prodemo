package com.utils.excelhelper.read.utils;
...
public class BaseReadUtil {
    ...
    public static <T> List<T> read(InputStream inputStream, Class<T> clazz)
            throws IOException, InvalidFormatException, IntrospectionException, InvocationTargetException, IllegalAccessException, InstantiationException {
     ...
     * 判断类型并设置值
     */
    private static void judgeTypeAndSetValue(Object object, Cell cell, Map<String, FieldInfo> fieldInfoMap, String titleString)
     ...
     * 获取导入字段
     */
    private static void getExcelField(Field field, FieldInfo fieldInfo, ExcelField excelField, Class<?> clazz) throws IntrospectionException {
