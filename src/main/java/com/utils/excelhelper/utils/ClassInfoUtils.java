package com.utils.excelhelper.utils;
...
public class ClassInfoUtils {
    ...
    private static boolean isExcelNumberType(String objString) {
        return objString.contains("Integer") || objString.contains("Long") || objString.contains("Short") || objString.contains("Byte")
                || objString.contains("BigInteger");
    }
    ...
    public static List<FieldInfo> getFieldInfoList(Class clazz) throws IntrospectionException {
        ...
        for (Field field : fields) {
            ...
            FieldInfo fieldInfo = new FieldInfo(name, order, format, width, defaultValue, getMethod, mergeTo, separator, string, tags);
