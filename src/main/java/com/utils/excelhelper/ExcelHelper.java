...
import com.utils.excelhelper.read.utils.BaseReadUtil;
import com.utils.excelhelper.write.utils.BaseWriteUtil;
...
public class ExcelHelper {
    ...
    public static byte[] write(Collection<?> collection, Class<?> clazz)
            throws InvocationTargetException, IntrospectionException, IllegalAccessException, NoSuchFieldException {
    ...
    public static <T> List<T> read(InputStream is, Class<T> clazz)
            throws IllegalAccessException, IntrospectionException, InvalidFormatException, IOException, InstantiationException, InvocationTargetException {
